...
KNOWLEDGE_BASE = {
    "questions": [
        {
            "id": "1",
            "question": "In a game, a player can score either 2 points or 5 points for each move. If a player has made 10 moves and scored 35 points, how many 2 point moves did the player make?",
            "answer": "5",
            "difficulty": "medium",
        },
        {
            "id": "2",
            "question": "Clout most closely means - Lump | Block | Prestige | Accumulate | Group",
            "answer": "Prestige",
            "difficulty": "easy",
        },
        {
            "id": "3",
            "question": "If the first two statements are true, is the final statement true? Most snakes are green. Most snakes are quick. At least one snake is both green and quick. (Yes/No)",
            "answer": "Yes",
            "difficulty": "medium",
        },
        {
            "id": "4",
            "question": "Identify the hidden pattern in the series of numbers, and use it to predict the next/missing number: 8 | 3 | 9 | 10 | 17 | ?",
            "answer": "25",
            "difficulty": "hard",
        },
        {
            ...
            "difficulty": "easy",
                ...
                {
            "id": "7",
            "question": "If there are 32 students in the classroom and 12.5% of them own at least one pet, how many students do not own any pets?",
            "answer": "28",
            "difficulty": "medium",
        },
        {
            "id": "8",
            "question": "IMPERIOUS is the opposite of: Moody|Subservient|Quiet|Stormy|Gloomy",
            "answer": "Subservient",
            "difficulty": "hard",
        },
        {
            "id": "9",
            "question": "Which word does not belong on this list? Solemn|Archaic|Grave|Mirthless|Serious ",
            "answer": "Archaic",
            "difficulty": "easy",
        },
        {
            "id": "10",
            "question": "Shelley has 7 dresses, 8 pairs of shoes, and 7 necklaces. If she wears one combination of clothes per day. How many days can she go without wearing the same outfit?",
            "answer": "392",
            "difficulty": "medium",
        },
        {
            "id": "11",
            "question": "When a smartphone is connected to a charger the battery charge increases by 4.5% per minute. When applications are in use the battery decreases by 3% per 2.5 minutes. What is the percentage of charging rate per minute if the phone is connected to a charger while several applications are in use?",
            "answer": "3.3",
            "difficulty": "hard",
        },
                {
        ...
        {
            "id": "14",
            "question": "A snail is at the bottom of a 20-foot well. Each day it climbs up 5 feet, but at night it slips back down 4 feet. How many days will it take for the snail to reach the top of the well?",
            "answer": "16",
            "difficulty": "hard",
        },
        {
            "id": "15",
            "question": "If tomorrow is Tuesday, what day was it yesterday?",
            "answer": "Sunday",
            "difficulty": "easy",
        },
        {
        ...
        {
            "id": "18",
            "question": "Rearrange the letters 'SILTEN' to form a word that means lacking sound.",
            "answer": "Silent",
            "difficulty": "easy",
        },
        {
            "id": "19",
            "question": "How many numbers between 1 and 100 are divisible by 6?",
            "answer": "16",
            "difficulty": "medium",
        },
        {
